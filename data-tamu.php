...
<div class="container" style="justify-content: center;">
    <form action="export-datatamu-excel.php" method="post">
   ...
   $sql = $pdo->prepare("SELECT * FROM tamu 
 ...
 <option value="nama">Nama Tamu</option>
  ...
  <a href="data-tamu.php" class="btn btn-danger">Reset</a>
    ...
    if($kolomCari=="" && $kolomKataKunci==""){
      $SqlQuery = mysqli_query($connect, "SELECT * FROM tamu WHERE tanggal_keluar = '-' ORDER BY no_antri DESC LIMIT ".$limitStart.",".$limit);
    }else{
      //kondisi jika parameter kolom pencarian diisi
      $SqlQuery = mysqli_query($connect, "SELECT * FROM tamu WHERE tanggal_keluar = '-' AND {$kolomCari} LIKE '%{$kolomKataKunci}%' ORDER BY no_antri DESC LIMIT ".$limitStart.",".$limit);
    }
        ...
        <tr>
            ...
            <td>
                ...
                <input type='<?php echo $hidden;?>' name='Submit' class="btn btn-success" value='Selesai'/>
                    ...
                    <?php echo "<a href='edit-data-tamu.php?no=".$data['no']."'>Edit</a>"?>
  ...
  <ul class="pagination">
    ...
    <?php
        ...
        if($kolomCari=="" && $kolomKataKunci==""){
        ?>
          <li><a href="data-tamu.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
     <?php     
        }else{
      ?> 
        <li><a href="data-tamu.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a></li>
       <?php
         } 
      }
    ?>
    ...
    <?php
      ...
      for($i = $startNumber; $i <= $endNumber; $i++){
        ...
        if($kolomCari=="" && $kolomKataKunci==""){
    ?>
        <li<?php echo $linkActive; ?>><a href="data-tamu.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>

    <?php
      }else{
        ?>
        <li<?php echo $linkActive; ?>><a href="data-tamu.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php
      }
    }
    ?>
