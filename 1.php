...
<form id='form2' action="home.php">
    ...
    <input type="number" autocomplete="off" class="form-control" id="input exampleFormControlInput1" placeholder="Suhu Tubuh Tamu" name="suhu_tubuh" step="0.01" value="" required>

    <label for="formFile" class="form-label"><b>Foto KTP : <b></label><br>
                <input type="file" class="form-control" id="formFile" name="foto" value="" required="required" accept="image/*;capture=camera">
